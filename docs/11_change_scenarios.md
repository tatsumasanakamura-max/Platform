...
SC1B-01として、JSON読込→順序・ラベル・placeholder・help・validator/message・visibility変更→Preview確認→JSON/差分出力→再Import→Undo/Redoを自動E2Eで確認する。代表シナリオは最大2件とし、複雑なシナリオ管理は行わない。
